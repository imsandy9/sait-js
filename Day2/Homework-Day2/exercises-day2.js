...
console.log ("Square root of width :",rect.height);


//8. console.log the rectangle's area (width * height). Use *dot notation* to access the properties!
console.log ("Rectangles area :", rect.height * rect.width);
...
var last= numbers[numbers.sort().length -1] ;
...
console.log ("Last value ", circle.radius);
...
var h= Math.sqrt(Math.pow(shapes[2].base,2) + Math.pow(shapes[2].height,2));
 shapes[2].hypotenuse=h;
 console.log(shapes);
